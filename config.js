...
// Database info
config.database  = {
    host:     (process.env.IDM_DB_HOST || '192.168.100.157'),
    password: (process.env.IDM_DB_PASS || 'abc1234'),
    username: (process.env.IDM_DB_USER || 'postgres'),
    database: (process.env.IDM_DB_NAME || 'idm'),
    dialect:  (process.env.IDM_DB_DIALECT || 'postgres'),
    port:     (process.env.IDM_DB_PORT || '5432')
